...
Route::group(['namespace' => 'ScientificController','middleware'=>['validate']], function (){
    ...
    Route::get('deleteallholdmeet', 'HoldmeetController@deleteAllHoldmeet');       //删除全部举行会议会议
    ...
    Route::get('deletejoinmeet', 'JoinmeetController@addJoinmeetImage');           //删除单个参加会议信息
    ...
    Route::get('deletelecture', 'LectureController@deleteLecture');                //删除单个专家讲学信息
    ...
    Route::get('deleteopus', 'OpusController@deleteOpus');                         //删除单个著作信息
    ...
    Route::get('deleteagreement','AgreementController@deleteAgreement');           //删除单个教学科研合作协议信息
