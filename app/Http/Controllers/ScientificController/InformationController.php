...
class InformationController extends Controller
{
    ...
    public function addTeacher(Request $request){
        ...
        $datas  = [
            ...
            'borth'                 => strtotime(trim($request->borth)),     //老师出生年月日
            ...
            'tennure_time'          => strtotime(trim($request->tennure_time)),//老师任职时间
            ...
            'review_time'           => strtotime(trim($request->review_time)),//评审通过时间
            'appointment_time'      => strtotime(trim($request->appointment_time)),//聘任时间
            ...
            'working_hourse'        => strtotime(trim($request->working_hours)),//老师来校工作时间
            ...
            'first_graduation_time' => strtotime(trim($request->first_graduation_time)),//老师第一学历毕业时间
            ...
            'most_graduation_time'  => strtotime(trim($request->most_graduation_time)),//老师最高学历毕业时间
            ...
            'master_time '          => strtotime(trim($request->master_time))//老师硕博导授予时间
        ];
